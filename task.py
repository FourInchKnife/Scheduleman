...
async def on_ready():
    ...
    await client.change_presence(activity=discord.CustomActivity("Waiting for: !day !week and !poll"))
@client.event
async def on_message(message):
    if message.content.startswith('!'):
        ...
        await message.edit(content=message.content.split("week: ",1)[1])
        ...
        await message.edit(content=message.content.split("day: ",1)[1])
